...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/winter-glitter-ade0
```

A live public deployment of this template is available at [https://winter-glitter-ade0.templates.workers.dev](https://winter-glitter-ade0.templates.workers.dev)
